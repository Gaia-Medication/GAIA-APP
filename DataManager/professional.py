...
#Identifiant PP,Code postal (coord. structure),Libell̩ commune (coord. structure),Libell̩ D̩partement (structure),T̩l̩phone (coord. structure),Adresse e-mail (coord. structure)
#2 3 456 89
BOLD = '\033[1m' # ACTIONS
